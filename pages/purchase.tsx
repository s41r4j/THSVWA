...
export default function Purchase() {
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-hacksmith-orange mb-4">Product Not Found</h1>
          <p className="text-gray-300 mb-6">The requested product could not be found.</p>
          <button
            onClick={() => router.push('/')}
            className="px-6 py-2 bg-hacksmith-orange text-white rounded-lg hover:bg-orange-600 transition-colors"
          >
            Return to Shop
          </button>
        </div>
  ...
  if (orderSuccess) {
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="max-w-md mx-auto text-center bg-hacksmith-gray p-8 rounded-lg shadow-lg border border-gray-700">
          <div className="text-green-400 text-6xl mb-4">✓</div>
          <h1 className="text-2xl font-bold text-white mb-4">Order Successful!</h1>
          ...
          <div className="space-y-3">
            <button
              onClick={() => router.push('/')}
              className="w-full px-6 py-2 bg-hacksmith-orange text-white rounded-lg hover:bg-orange-600 transition-colors"
            >
              Continue Shopping
            </button>
            <button
              onClick={() => setOrderSuccess(false)}
              className="w-full px-6 py-2 bg-gray-700 text-gray-300 rounded-lg hover:bg-gray-600 transition-colors"
            >
              Place Another Order
            </button>
          </div>
  ...
  return (
    <div className="py-8">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-hacksmith-gray rounded-lg shadow-lg overflow-hidden border border-gray-700">
          {/* Header */}
          <div className="bg-gradient-to-r from-hacksmith-orange to-orange-600 text-white p-6">
            <h1 className="text-2xl font-bold">Complete Your Purchase</h1>
            <p className="text-orange-100 mt-2">Secure checkout for {product.name}</p>
          </div>
          ...
          <div className="p-6">
            <div className="grid md:grid-cols-2 gap-8">
              {/* Product Information */}
              <div>
                <div className="border border-gray-600 rounded-lg p-4 mb-6 bg-gray-800">
                  <img
                    src={product.image}
                    alt={product.name}
                    className="w-full h-48 object-contain mb-4 bg-white rounded-lg p-2"
                  />
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-lg font-semibold text-gray-300">Unit Price:</span>
                      <span className="text-lg font-bold text-hacksmith-orange">${product.price}</span>
                    </div>
                    
                    <div className="flex items-center justify-between">
                      <label htmlFor="quantity" className="text-lg font-semibold text-gray-300">Quantity:</label>
                      <input
                        id="quantity"
                        type="number"
                        min="1"
                        ...
                        className="w-20 px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-hacksmith-orange focus:border-transparent"
                      />
                    </div>

                    {/* Price Manipulation Vulnerability */}
                    <div className="flex items-center justify-between border-t border-gray-600 pt-4">
                      <label htmlFor="price" className="text-lg font-semibold text-gray-300">Price per item:</label>
                      <input
                        id="price"
                        type="number"
                        step="0.01"
                        ...
                        className="w-32 px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-hacksmith-orange focus:border-transparent"
                      />
                    </div>
                    
                    <div className="flex items-center justify-between border-t border-gray-600 pt-4">
                      <span className="text-xl font-bold text-gray-300">Total:</span>
                      <span className="text-xl font-bold text-hacksmith-orange">
              ...
              <div>
                <div className="border border-gray-600 rounded-lg p-4 bg-gray-800">
                  <h3 className="text-lg font-bold text-white mb-4">📋 Order Documentation</h3>
                  <p className="text-gray-300 mb-4">Access order templates and shipping information:</p>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-hacksmith-orange focus:border-transparent"
                      />
                    </div>
                    
                    <button
                      onClick={handleFileExplore}
                      className="w-full py-2 px-4 bg-hacksmith-orange text-white rounded-lg hover:bg-orange-600 transition-colors"
                    >
                      📂 Load Document
                    </button>
                    ...
                    {fileContent && (
                      <div className="mt-4">
                        <h4 className="font-semibold text-white mb-2">Document Content:</h4>
